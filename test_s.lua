...
test('half',"F90000",0.0,    function() return cbor.encode_float(0.0)  end)
test('half',"F98000",-0.0,   function() return cbor.encode_float(-0.0) end)
test('half',"F93C00",1.0,    function() return cbor.encode_float(1.0)  end)
test('half',"F93E00",1.5)
test('single',"fa7f7fffff",3.4028234663852886e+38,
	function()
	  return cbor.encode_float(3.40282346638528859811704183484516925440e+38)
	end)
test('double',"fb7e37e43c8800759c",1.0e+300,
	function()
	  return cbor.encode_float(1.0e+300)
	end)
test('half',"f90001",5.960464477539063e-8)
test('half',"f90400",0.00006103515625)
test('half',"f9c400",-4.0,function() return cbor.encode_float(-4) end)
